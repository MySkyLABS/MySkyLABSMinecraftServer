...
public class ColorHelmetListener extends Listener {
/*
                            ...
                            Gui.open(p, new Gui("§8Farbe Wählen", 1){
								...
								public DynamicObject onClick(DynamicObject args) {
                                    ...
                                    if (slotY == 1) {
                                        switch (slotX) {
                                            case 1:
                                            ColorHelmetListener.setColor(Color.fromRGB(0x000000), p);
                                            break;
                                            case 2:
                                            ColorHelmetListener.setColor(Color.fromRGB(0x888888), p);
                                            break;
                                            case 3:
                                            ColorHelmetListener.setColor(Color.fromRGB(0xFFFFFF), p);
                                            break;
                                            case 4:
                                            ColorHelmetListener.setColor(Color.fromRGB(0x8B4513), p);
                                            break;
                                            case 5:
                                            ColorHelmetListener.setColor(Color.fromRGB(0xFF0000), p);
                                            break;
                                            case 6:
                                            ColorHelmetListener.setColor(Color.fromRGB(0x00FF00), p);
                                            break;
                                            case 7:
                                            ColorHelmetListener.setColor(Color.fromRGB(0x0040FF), p);
                                            break;
                                        }
                                    } else if (slotY == 2) {
                                        switch (slotX) {
                                            case 1:
                                            ColorHelmetListener.setColor(Color.fromRGB(0xEE82EE), p);
                                            break;
                                            case 2:
                                            ColorHelmetListener.setColor(Color.fromRGB(0x00f700), p);
                                            break;
                                            case 3:
                                            ColorHelmetListener.setColor(Color.fromRGB(0xFFFF00), p);
                                            break;
                                            case 4:
                                            ColorHelmetListener.setColor(Color.fromRGB(0xFF8800), p);
                                            break;
                                            case 5:
                                            ColorHelmetListener.setColor(Color.fromRGB(0xFF00FF), p);
                                            break;
                                            case 6:
                                            ColorHelmetListener.setColor(Color.fromRGB(0x551A8B), p);
                                            break;
                                            case 7:
                                            ColorHelmetListener.setColor(Color.fromRGB(0x00FFFF), p);
                                            break;
                                        }
                                    }
    ...
    private static void updateTickAsync(Player p) {
        ...
        if (helmet != null && helmet.hasItemMeta() && helmet.getItemMeta().hasDisplayName()) {
            ...
            if (name.startsWith("§r§l§r") && helmet.getItemMeta() instanceof LeatherArmorMeta) {
                ...
                Point3D center = new Point3D(location).add(0, 1, 0);
                Grid grid = new Grid(center, new Rotation(location.getYaw(), 0));

                for (Entity entity : getNearbyEntities(p, 20)) {
                    if (entity instanceof Player) {
                        Player t = (Player) entity;

                        Point3D point = grid.fromGridPoint(1, 0, 0);
                        ...
                        point = grid.fromGridPoint(-1, 0, 0);
                        sendPacket(t, new PacketPlayOutWorldParticles(EnumParticle.REDSTONE, true, point.getXFloat(), point.getYFloat(), point.getZFloat(), r, g, b, 1, 0));
                        point = grid.fromGridPoint(0, 0, 1);
                        sendPacket(t, new PacketPlayOutWorldParticles(EnumParticle.REDSTONE, true, point.getXFloat(), point.getYFloat(), point.getZFloat(), r, g, b, 1, 0));
                        point = grid.fromGridPoint(0, 0, -1);
                        sendPacket(t, new PacketPlayOutWorldParticles(EnumParticle.REDSTONE, true, point.getXFloat(), point.getYFloat(), point.getZFloat(), r, g, b, 1, 0));
                    }
