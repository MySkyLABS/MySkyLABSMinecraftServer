...
public class ColorShoes extends ShapedRecipe {
    ...
    public ColorShoes() {
        ...
        CraftingSystem.set(this, 'S', new ItemStack(301));
    ...
    public static ItemStack get() {
        ItemStack is = new ItemStack(301);
        ItemMeta im = is.getItemMeta();
        im.setDisplayName("§r§l§r§f§lUltra Boots");
